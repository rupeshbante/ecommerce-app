...
export interface SalesReport { totalRevenue: number; totalOrders: number; totalCustomers: number; totalProducts: number; dailyRevenue: ChartData[]; monthlyRevenue: ChartData[]; topProducts: TopProduct[]; categoryRevenue: CategoryRevenue[]; ordersByStatus: StatusCount[]; }
