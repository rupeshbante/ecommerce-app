...
export interface CreateOrder { shippingAddress: string; items: CartItemDto[]; couponCode?: string; addressId?: number; guestEmail?: string; guestName?: string; guestPhone?: string; pointsToRedeem?: number; }
